...
INSERT INTO `ADDRESS_TYPES` VALUES (1,'Home','2018-10-17 18:20:29',NULL),(2,'Billing','2018-10-17 18:20:29',NULL),(3,'Office','2018-10-17 18:20:29',NULL),(4,'Primary','2018-10-17 18:20:29',NULL),(5,'Shipping','2018-10-17 18:20:29',NULL);
...
INSERT INTO `COUNTRIES` VALUES (1,'US','United States','2018-10-17 18:20:28',NULL),(2,'CO','Colombia','2018-10-17 18:20:29',NULL),(3,'CA','Canada','2018-10-17 18:20:29',NULL),(4,'ES','Spain','2018-10-17 18:20:29',NULL),(5,'FR','France','2018-10-17 18:20:29',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Source of the ID that connects providers and patients with address and contact information.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ENTITIES` VALUES (1,'2018-10-17 18:20:28'),(2,'2018-10-17 18:20:28');
...
INSERT INTO `PERSONS` VALUES (1,1,NULL,'Yesid',NULL,'Perea','Martinez',NULL,'2018-10-17 18:20:28',NULL),(2,3,NULL,'Claudia','Patricia','Carabali','Chacon',NULL,'2018-10-17 18:20:28',NULL);
...
CREATE TABLE `PERSON_TYPES` (
  ...
  `PersonTypeName` varchar(45) DEFAULT NULL COMMENT 'Patient, Provider, Employee ',
  `CreatedDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Date and time the record was created.',
  `ModifiedDate` datetime DEFAULT NULL COMMENT 'Date and time the record was last updated.',
  PRIMARY KEY (`PersonTypeID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Type of a person.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `PERSON_TYPES` VALUES (1,'Employee','2018-10-17 18:20:28',NULL),(2,'Provider','2018-10-17 18:20:28',NULL),(3,'Patient','2018-10-17 18:20:28',NULL);
...
CREATE TABLE `PERSON_USERS` (
  `PersonID` int(11) NOT NULL,
  `PersonTypeID` int(11) NOT NULL DEFAULT '3',
...
INSERT INTO `PERSON_USERS` VALUES (1,1,1,'2018-10-17 18:20:28'),(2,3,2,'2018-10-17 18:20:28');
...
INSERT INTO `ROLES` VALUES (1,'Administrator','System administrator','2018-10-17 18:20:27',NULL),(2,'User','System user','2018-10-17 18:20:27',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='State and province lookup table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `STATE_PROVINCES` VALUES (1,'AK','Alaska',1,'2018-10-17 18:20:29',NULL),(2,'AL','Alabama',1,'2018-10-17 18:20:29',NULL),(3,'AR','Arkansas',1,'2018-10-17 18:20:29',NULL),(4,'AZ','Arizona',1,'2018-10-17 18:20:29',NULL),(5,'CA','California',1,'2018-10-17 18:20:29',NULL),(6,'WI','Wisconsin',1,'2018-10-17 18:20:29',NULL),(7,'AB','Alberta',3,'2018-10-17 18:20:29',NULL),(8,'BC','British Columbia',3,'2018-10-17 18:20:29',NULL),(9,'LB','Labrador',3,'2018-10-17 18:20:29',NULL),(10,'MB','Manitoba',3,'2018-10-17 18:20:29',NULL),(11,'NB','Brunswick',3,'2018-10-17 18:20:29',NULL);
...
INSERT INTO `USERS` VALUES (1,'yesper','yesper@aol.com','1234','2018-10-17 18:20:27',NULL),(2,'clacar','clacar@aol.com','1234','2018-10-17 18:20:28',NULL);
...
CREATE TABLE `USERS_ROLES` (
  ...
  CONSTRAINT `fk_ROLES_has_USERS_ROLES1` FOREIGN KEY (`RoleID`) REFERENCES `ROLES` (`RoleID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ROLES_has_USERS_USERS1` FOREIGN KEY (`UserID`) REFERENCES `USERS` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `USERS_ROLES` VALUES (1,1,'2018-10-17 18:20:28'),(2,2,'2018-10-17 18:20:28');
...
-- Dump completed on 2018-10-17 19:40:21
