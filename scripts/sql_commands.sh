...
CREATE INDEX fk_TREATMENTS_DIAGNOSIS1_idx ON TREATMENTS (DiagnosticID ASC);
...
CREATE INDEX fk_PRESCRIPTIONS_DIAGNOSIS1_idx ON PRESCRIPTIONS (DiagnosticID ASC);
