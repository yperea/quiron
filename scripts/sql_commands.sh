...
CREATE TABLE IF NOT EXISTS TREATMENTS (
  ...
  SymptomID INT NULL,
  SymptomName NVARCHAR(45) NULL,
  DiagnosticID INT NULL,
  DiagnosticName NVARCHAR(512) NULL,
...
INSERT INTO TREATMENTS(VisitID, SymptomID, SymptomName, DiagnosticID, DiagnosticName, StartDate, EndDate, PatientComments, ProviderComments, Status, Evaluation)VALUES(1, 10, 'Headache', 1, 'Diagnostic 1', '2018-01-01', '2018-02-01', 'I feel better now', 'Follow treatment', 'C', 4.5);
INSERT INTO TREATMENTS(VisitID, SymptomID, SymptomName, DiagnosticID, DiagnosticName, StartDate, EndDate, PatientComments, ProviderComments, Status, Evaluation)VALUES(2, 10, 'Headache', 1, 'Diagnostic 1', '2018-01-01', '2018-02-01', 'I feel better now', 'Follow treatment', 'C', 4.5);
