...
INSERT INTO TREATMENTS(VisitID, SymptomID, SymptomName, DiagnosticID, DiagnosticName, StartDate, EndDate, PatientComments, ProviderComments, Status, Evaluation)VALUES(1, 10, 'Sore throat', 1, 'Diagnostic 1', '2018-01-01', '2018-02-01', 'I feel better now', 'Follow treatment', 'C', 4.5);
INSERT INTO TREATMENTS(VisitID, SymptomID, SymptomName, DiagnosticID, DiagnosticName, StartDate, EndDate, PatientComments, ProviderComments, Status, Evaluation)VALUES(2, 10, 'Headache', 2, 'Diagnostic 2', '2018-01-01', '2018-02-01', 'I feel better now', 'Follow treatment', 'C', 4.0);
