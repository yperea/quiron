        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group mr-2">
                    <a class="btn btn-sm btn-outline-danger" href="${root}/patient/visits?state=1" role="button">Upcoming</a>
                    &nbsp;
                    <a class="btn btn-sm btn-outline-warning" href="#" role="button">Completed</a>
                    &nbsp;
                    <a class="btn btn-sm btn-outline-success" href="#" role="button">Canceled</a>
                    &nbsp;
                </div>
                <!--
